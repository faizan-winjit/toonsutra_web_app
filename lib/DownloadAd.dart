...
// DownloadMessage
// Sub-Widget of DownloadAd Widget
  Widget DownloadMessage(message) {
    return AspectRatio(
        aspectRatio: 4 / 1,
        child: LayoutBuilder(builder: ((context, constraints) {
          double availableHeight = constraints.maxHeight;
          double messageSize = availableHeight * 0.23;
          return Text(
            message,
...
// DownlaodIcons - The Google Play & App Store Downlaod Icons
// Sub-widget of DownloadAd Widget
  Widget DownloadIcons() {
    return AspectRatio(
      aspectRatio: 3 / 1,
      child: FittedBox(
        child: Row(
...
//---------------------------------------------------------------------------------------------------------
// DownloadMobile Image
// Sub-Widget of DownloadAd Widget
  Widget DownloadMobileImage() {
    return AspectRatio(
        aspectRatio: 1 / 2,
        child: FittedBox(
  ...
  Widget DownloadMessageAndIcons(String message) {
    return Column(
      children: [
  ...
  Widget build(BuildContext context) {
    return FractionallySizedBox(
      widthFactor: 0.9,
      /* child: DownloadMessageAndIcons(
          'Download and Read Astra The Immortal on the ToonSutra App today!'),*/

      child: AspectRatio(
        aspectRatio: 1588 / 217,
        child: Container(
...
Widget DownloadAdTemp(bool mobile) {
  return AspectRatio(
